          ...
          <div className="flex min-h-full items-center justify-center p-6">
            ...
            >
              <DialogPanel className="w-full max-w-xl transform overflow-hidden rounded-xl bg-white text-left align-middle shadow-xl transition-all">
                <div className="bg-[#D97706] px-6 py-4 rounded-t-xl flex items-center gap-4">
                  {icon && (
                    <OctagonAlert className="h-8 w-8 text-white" />
                  )}
                  <DialogTitle
                    as="h3"
                ...
                <div className="bg-white px-6 py-6">
                  ...
                  <div className="mt-8 flex justify-center gap-4">
                    <button
                      type="button"
                      className="w-[140px] h-[40px] bg-[#F59E0B] rounded-full border border-gray-300 text-white font-medium shadow-sm hover:bg-[#D97706] cursor-pointer"
                      onClick={onClose}
                    >
                      {cancelLabel}
                    </button>
