...
import { showError } from '../../../features/backofficeLoginSlice'
...
export default function ErrorModal({ buttonText }) {
    ...
    const { errorMessage } = useSelector((state) => state.backofficeLogin)

    const safeErrorMessage = errorMessage || "An unknown error occured"
